...
test('object-level conversion', t => {
  ...
  t.deepEqual(flatten({ a: { b: { c: 'd' } }, e: 'f' }), {
    'a.b.c': 'd',
    e: 'f'
  });
  t.deepEqual(flatten({ a: { b: { c: 'd' }, e: 'f' } }), {
...
test('convert arrays', t => {
  ...
  t.deepEqual(flatten({ a: { b: ['c', 'd'] } }), {
    'a.b$0': 'c',
    'a.b$1': 'd'
  });
  t.deepEqual(flatten({ a: { b: ['c', 'd'], e: null } }), {
    'a.b$0': 'c',
    'a.b$1': 'd'
  });
  t.deepEqual(flatten({ a: { b: ['c', 'd'], e: undefined } }), {
    'a.b$0': 'c',
    'a.b$1': 'd'
  });
  t.deepEqual(flatten({ a: { b: ['c', 'd'], e: true } }), {
    'a.b$0': 'c',
    'a.b$1': 'd',
    'a.e': true
  });
